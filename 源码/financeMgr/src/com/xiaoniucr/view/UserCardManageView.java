 ...
 *
 */
public class UserCardManageView extends JFrame {

	private JPanel contentPane;
	private JTable table;
	private JTextField titleText;
	private UserCardManageView frame = this;
	private CardDao cardDao = new CardDao();

	/**
	 * Create the frame.
	 */
	public UserCardManageView() {
		...
		Object[] columns = { "ID", "卡号", "银行", "余额", "备注", "添加时间", };// 字段
		...
		addBtn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				UserCardAddView view = new UserCardAddView(frame);
		...
		updateBtn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				UserCardUpdateView view = new UserCardUpdateView(id,frame);
				view.setVisible(true);
