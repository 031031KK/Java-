 ...
 *
 */
public class AdminUserUpdateView extends JFrame {
	 ...
	 * Create the frame.
	 */
	public AdminUserUpdateView(final Integer id,final AdminUserManageView frame) {
		setTitle("志愿者编辑");
		setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
		setBounds(100, 100, 388, 510);
		...
		saveBtn.setBounds(118, 388, 74, 23);
		...
		cancleBtn.setBounds(202, 388, 74, 23);
